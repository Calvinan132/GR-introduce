      ...
      <header className="relative pt-32 pb-20 px-4 overflow-hidden flex flex-col items-center justify-center min-h-[50vh]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-6">
          <ScrollReveal animation="fade-down" delay={100} duration={800}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 mb-4 animate-none">
          ...
          <ScrollReveal animation="zoom-in" delay={250} duration={900}>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
          ...
          <ScrollReveal
            ...
            className="h-full"
          >
            <div className="bg-background rounded-3xl p-8 border border-primary/20 shadow-xl relative overflow-hidden group hover:border-primary/50 transition-colors duration-500 h-full">
          ...
          {/* Đối với Người dùng */}
          <ScrollReveal animation="fade-left" duration={800} className="h-full">
            <div className="bg-background rounded-3xl p-8 border border-primary/20 shadow-xl relative overflow-hidden group hover:border-primary/50 transition-colors duration-500 h-full">
              <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity duration-500 transform group-hover:scale-110">
                <Users size={180} />
              </div>
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-4">
                  {[
                    {
                      icon: Search,
                      text: "Dễ dàng tìm kiếm sự kiện yêu thích",
                    },
                    {
                      icon: Ticket,
      ...
      <section className="bg-primary/5 py-24 px-4 border-t border-primary/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollReveal animation="zoom-in" delay={100} duration={700}>
              <div className="bg-background p-6 rounded-2xl shadow-sm border border-primary/10 hover:-translate-y-2 transition-transform duration-300 h-full">
            ...
            <ScrollReveal animation="zoom-in" delay={250} duration={700}>
              <div className="bg-background p-6 rounded-2xl shadow-sm border border-primary/10 hover:-translate-y-2 transition-transform duration-300 h-full">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 text-primary">
                  <ShieldCheck size={24} />
                </div>
            ...
            <ScrollReveal animation="zoom-in" delay={400} duration={700}>
              <div className="bg-background p-6 rounded-2xl shadow-sm border border-primary/10 hover:-translate-y-2 transition-transform duration-300 h-full">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 text-primary">
                  <Users size={24} />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <p className="text-foreground/70 leading-relaxed max-w-xl">
                  ...
                  một cách minh bạch thông qua nền tảng GitHub. Dự án được áp
                  dụng mô hình Git Flow chuẩn hóa, đảm bảo tính nhất quán, bảo
                  mật và chất lượng mã nguồn cao.
                </p>
              ...
              <div className="lg:col-span-5 flex justify-center">
                <div className="w-full max-w-sm bg-background/60 border border-primary/30 p-8 rounded-3xl backdrop-blur-xl shadow-2xl relative group/card hover:border-primary/60 transition-all duration-500 hover:-translate-y-1">
                  ...
                  <div className="flex flex-col items-center text-center space-y-6 relative z-10">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-1">CHEVE</h3>
                    ...
                    <p className="text-xs text-foreground/60 leading-relaxed">
                      ...
                      (contribute) trực tiếp thông qua pull request trên hệ
                      thống của chúng tôi.
                    </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {docs?.map((sprint, index) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="bg-background rounded-3xl p-6 border border-primary/20 shadow-xl hover:border-primary/50 transition-colors group flex flex-col h-full">
