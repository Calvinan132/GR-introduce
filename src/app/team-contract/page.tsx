...
export default function TeamContractPage() {
    const googleDocsId = "1Px0Q8E4pDifXNNYXDCa_JRF3fN3z_uVtCfV16t9ol4Y";
    const embedUrl = `https://docs.google.com/document/d/${googleDocsId}/preview`;
    const editUrl = `https://docs.google.com/document/d/${googleDocsId}/edit`;
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
                        Văn bản cam kết về nguyên tắc làm việc, kế hoạch và tiêu chí đánh giá nhằm đảm bảo hiệu quả tối đa cho đồ án nhóm.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        <div className="flex items-center justify-between bg-white dark:bg-[#062d24] p-4 rounded-xl border border-gray-100 dark:border-white/5 shadow-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="ml-2 text-sm font-medium opacity-70">Google Docs Preview</span>
                            </div>
                            <a
                                href={editUrl}
                                target="_blank"
                            ...
                            <div className="space-y-4 text-sm">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="opacity-80">Online (Google Meet) hoặc Offline tại trường ĐH CNTT.</p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="opacity-80">1 lần/tuần để báo cáo tiến độ và gỡ rối khó khăn.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="space-y-4 text-sm relative z-10">
                                <div className="p-3 bg-emerald-500/10 rounded-lg border border-emerald-500/20">
                                    ...
                                    <p className="mt-1 opacity-90 italic">
                                        Hoàn thành xuất sắc, đóng góp sáng kiến hoặc fix bug lớn sẽ được leader **Tạ Duy Phúc** mời 1 ly Ngô Gia.
                                    </p>
                                </div>
                                <div className="p-3 bg-red-500/10 rounded-lg border border-red-500/20">
                                    ...
                                    <p className="mt-1 opacity-90 italic">
                                        Chậm tiến độ, thiếu tích cực sẽ bị cảnh cáo, trừ điểm hoặc loại khỏi nhóm.
                                    </p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="bg-white dark:bg-[#062d24] p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs opacity-70 italic text-right max-w-[200px]">Xuất sắc, sáng tạo, Leader</span>
                                </div>
                                <div className="flex justify-between items-center p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors">
                                    <span className="font-bold text-blue-500">7 - 8</span>
                                    <span className="text-xs opacity-70 italic text-right max-w-[200px]">Hoàn thành tốt nhiệm vụ</span>
                                </div>
                                <div className="flex justify-between items-center p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors">
                                    <span className="font-bold text-orange-500">5 - 6</span>
                                    <span className="text-xs opacity-70 italic text-right max-w-[200px]">Còn nhiều thiếu sót</span>
                                </div>
                                <div className="flex justify-between items-center p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors">
                                    <span className="font-bold text-red-500">0</span>
                                    <span className="text-xs opacity-70 italic text-right max-w-[200px]">Không tham gia</span>
                                </div>
                            </div>
                        </section>
